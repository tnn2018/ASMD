...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoint_res12306', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='./checkpoint_res32_C100/checkpoint.pth.tar', type=str, metavar='PATH',   # ./checkpoint/checkpoint.pth.tar
